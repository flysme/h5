  ...
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "van-contact-list" }, [_c('van-radio-group', { attrs: { "value": _vm.value }, on: { "input": function input($event) {
      ...
      return _c('van-cell', { key: item.id }, [_c('van-radio', { attrs: { "name": item.id }, on: { "click": function click($event) {
          ...
          } } }, [_c('p', { staticClass: "van-contact-list__text" }, [_vm._v(_vm._s(_vm.$t('name')) + "：" + _vm._s(item.name))]), _c('p', { staticClass: "van-contact-list__text" }, [_vm._v(_vm._s(_vm.$t('tel')) + "：" + _vm._s(item.tel))])]), _c('van-icon', { staticClass: "van-contact-list__edit", attrs: { "name": "edit" }, on: { "click": function click($event) {
            _vm.$emit('edit', item, index);
          } } })], 1);
    }))], 1), _c('van-cell', { staticClass: "van-contact-list__add van-hairline--top", attrs: { "icon": "add", "title": _vm.addText || _vm.$t('addText'), "isLink": "" }, on: { "click": function click($event) {
          _vm.$emit('add');
        } } })], 1);
  },

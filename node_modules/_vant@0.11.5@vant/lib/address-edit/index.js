...
exports.default = {
  render: function render() {
    var _vm = this;var _h = _vm.$createElement;var _c = _vm._self._c || _h;return _c('div', { staticClass: "van-address-edit" }, [_c('van-cell-group', [_c('van-field', { attrs: { "maxlength": "15", "placeholder": _vm.$t('placeholder.name'), "label": _vm.$t('label.name', _vm.computedAddressText), "error": _vm.errorInfo.name }, on: { "focus": function focus($event) {
          _vm.onFocus('name');
        } }, model: { value: _vm.currentInfo.name, callback: function callback($$v) {
          _vm.$set(_vm.currentInfo, "name", $$v);
        }, expression: "currentInfo.name" } }), _c('van-field', { attrs: { "type": "tel", "label": _vm.$t('label.tel'), "placeholder": _vm.$t('placeholder.tel'), "error": _vm.errorInfo.tel }, on: { "focus": function focus($event) {
          _vm.onFocus('tel');
        } }, model: { value: _vm.currentInfo.tel, callback: function callback($$v) {
          _vm.$set(_vm.currentInfo, "tel", $$v);
        }, expression: "currentInfo.tel" } }), _c('van-cell', { staticClass: "van-address-edit__area", attrs: { "title": _vm.$t('areaTitle') }, on: { "click": function click($event) {
          _vm.showAreaSelect = true;
        } } }, [_c('span', [_vm._v(_vm._s(_vm.currentInfo.province || _vm.$t('placeholder.province')))]), _c('span', [_vm._v(_vm._s(_vm.currentInfo.city || _vm.$t('placeholder.city')))]), _c('span', [_vm._v(_vm._s(_vm.currentInfo.county || _vm.$t('placeholder.county')))])]), _c('van-address-edit-detail', { attrs: { "value": _vm.currentInfo.address_detail, "isError": _vm.errorInfo.address_detail, "showSearchResult": _vm.showSearchResult, "searchResult": _vm.searchResult }, on: { "focus": function focus($event) {
          _vm.onFocus('address_detail');
        }, "blur": _vm.onDetailBlur, "input": _vm.onChangeDetail } }), _vm.showPostal ? _c('van-field', { directives: [{ name: "show", rawName: "v-show", value: !_vm.hideBottomFields, expression: "!hideBottomFields" }], staticClass: "van-hairline--top", attrs: { "type": "tel", "label": _vm.$t('label.postal'), "placeholder": _vm.$t('placeholder.postal'), "maxlength": "6", "error": _vm.errorInfo.postal_code }, on: { "focus": function focus($event) {
